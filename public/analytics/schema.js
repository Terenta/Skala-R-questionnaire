(() => {
  ...
  const questions = [
    ...
    { key: "b4", code: "B4", title: "Негатив о продуктах нашей компании", type: "single", options: negativeFrequency },
    { key: "b5", code: "B5", title: "Кто сообщает негатив о продукте", type: "multi", options: roles },
    { key: "b6", code: "B6", title: "Причины недоверия к продуктам нашей компании", type: "multi", options: productDistrust },
